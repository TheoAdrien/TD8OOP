...
\begin{figure}[ht]
 \centering
 \includegraphics[width=90mm]{./images/xkcd_867_dendrograms.png}
...
\begin{etape}
 ...
 \begin{enumerate}
  ...
  \item send us the URL for your project (if it is public) or invite us as contributors (if it is private) so that we can monitor your progress;
  \item if you are already comfortable with git, create you own branch with \texttt{git branch -b devLastnameFirstname} (obviously, adapt Lastname and Firstname). Reminder: you might want to read the section on branches from a git tutorial\footnoteURL{https://bioinfo-fr.net/git-usage-collaboratif};
...
\begin{etape}
 ...
 Do not forget fot fill the docstring comments.
...
\begin{etape}
 ...
 \texttt{GroupOfStudents} is a sub-class of \texttt{java.util.ArrayList}\footnoteURL{http://docs.oracle.com/javase/7/docs/api/java/util/ArrayList.html} \fixme{or \texttt{java.util.Vector}???}. Make sure to read the documentation for \texttt{ArrayList}, you will need it soon.
